...
//user test listen mode
#define RADIO_DIO_4_PORT                    GPIOB
#define RADIO_DIO_4_PIN                     GPIO_PIN_15
#define RADIO_DIO_4_GPIO_CLK_ENABLE()       __HAL_RCC_GPIOB_CLK_ENABLE()
#define RADIO_DIO_4_EXTI_LINE               EXTI_LINE_15
#define RADIO_DIO_4_IRQn                    EXTI4_15_IRQn
#define H_EXTI_15                           hRADIO_DIO_exti[4]
//end user define Dio4 in listen mode
